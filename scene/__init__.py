...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        elif os.path.exists(os.path.join(args.source_path, "data_views.json")):
            print("Found data_views.json file, assuming OmniPhotos data set!")
            scene_info = sceneLoadTypeCallbacks["OmniPhotos"](args.source_path, args.white_background, args.eval)
        else:
